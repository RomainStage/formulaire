...
index.verif_formulaire = function (){
	...
	objet.email = document.getElementById("email").value;
...
ca2 = ca n-2
ca22 = ca n+2
si CA n-2 < CA n-1 < CA n < CA n+1 < CA n+2
retourn 2
sinon 1
0 si pas remplie
*/
...
var checkmail = function(){
	...
	document.getElementById("email-control").innerHTML = "Entrer un mail valide SVP";
	}
	};
